  ...
  if (!fs.existsSync(DB_PATH)) {
    const initial = {
      ...
      parts: [
        ...
        { id: 'p9', name: 'Rear Windshield', brand: 'Toyota', model: 'Fortuner', year: '2017-2022', category: 'Glass', condition: 'Good', price: 4200, stock: 2, desc: 'Clear glass with minor chip near edge', icon: '🪟', sku: 'TY-GL-009', images: [], rating: 4.1, reviews: 8, createdAt: new Date().toISOString() },
        { id: 'p10', name: 'Tail Light Assembly', brand: 'Mahindra', model: 'Scorpio', year: '2016-2021', category: 'Electrical', condition: 'New', price: 2600, stock: 4, desc: 'OEM style fitment and fully tested', icon: '💡', sku: 'MA-EL-010', images: [], rating: 4.7, reviews: 13, createdAt: new Date().toISOString() },
        { id: 'p11', name: 'Power Steering Pump', brand: 'Ford', model: 'EcoSport', year: '2018-2023', category: 'Steering', condition: 'Good', price: 6100, stock: 1, desc: 'Smooth assist, no leaks observed', icon: '🎯', sku: 'FO-ST-011', images: [], rating: 4.3, reviews: 10, createdAt: new Date().toISOString() },
        { id: 'p12', name: 'Battery 60Ah', brand: 'Amaron', model: 'GT', year: '2020-2024', category: 'Electrical', condition: 'Good', price: 9800, stock: 2, desc: 'Healthy charge, ready for installation', icon: '🔋', sku: 'AM-EL-012', images: [], rating: 4.8, reviews: 16, createdAt: new Date().toISOString() }
      ],
      orders: [
